  ...
  return <motion.div initial={{
    ...
    duration: 0.5
      ...
      <header className="relative h-[50vh] flex items-center justify-center text-center text-white">
        <img className="absolute inset-0 w-full h-full object-cover -z-10" alt="A person happily receiving a rebate check" src="https://horizons-cdn.hostinger.com/c22cdeb8-ea99-4bf3-beb4-ce34d6fb856b/chatgpt-image-sep-15-2025-01_19_18-pm-PoM8n.png" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          duration: 0.8
        }} className="text-4xl md:text-6xl font-bold">Victorian Energy Upgrades </motion.h1>
          <motion.p initial={{
          opacity: 0,
          y: 20
        }} animate={{
          ...
          duration: 0.8,
          delay: 0.2
        }} className="mt-4 text-xl md:text-2xl">Unlock Up to $9,900* in Government Incentives</motion.p>
        </div>
      </header>
