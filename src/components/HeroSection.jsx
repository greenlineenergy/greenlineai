...
const HeroSection = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center hero-bg">
      <img
        ...
        alt="Modern eco-home with solar panels on roof"
        src="https://horizons-cdn.hostinger.com/c22cdeb8-ea99-4bf3-beb4-ce34d6fb856b/chatgpt-image-oct-9-2025-06_04_16-pm-1-a2wxi.png"
        fetchpriority="high"
        decoding="async"
      />
