  ...
  return (
    <section id="services" className="py-20 bg-dark-background"> {/* Adjusted for dark background */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6"> {/* Adjusted for dark background */}
            Our <span className="text-gradient">Energy Solutions</span>
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-light-text max-w-3xl mx-auto"> {/* Adjusted for dark background */}
            Comprehensive renewable energy services designed to reduce your environmental impact and energy costs
          </p>
        </motion.div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 xl:gap-10">
