  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-80 h-[450px] bg-gray-900 border border-lime-500/30 rounded-2xl shadow-glow flex flex-col z-50"
          >
      ...
      <motion.button
        ...
        className="fixed bottom-24 right-6 bg-gradient-to-r from-lime-500 to-teal-500 w-16 h-16 rounded-full flex items-center justify-center shadow-lg z-50"
